package com.example.veflix.core.logger
...
class VeflixLogger @Inject constructor(
) : Logger {

    override fun setup(debugMode: Boolean, context: Context) {
        if (debugMode) {
            Timber.plant(NewsPulseDebugTree())
        }
    }
 ...
 */
private class NewsPulseDebugTree : Timber.DebugTree() {
